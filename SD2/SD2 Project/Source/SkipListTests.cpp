/**
 * Skip-list data structure testing
 */
...
void inputUniqueSortedIntegerValues(int numberOfElements) {
    ...
    SkipList<int> object(maxLevel, levelProbability);
...
void copyStructure(int numberOfElements) {
    ...
    SkipList<int> object1(maxLevel, levelProbability);
    SkipList<int> object2(maxLevel, levelProbability);
    int value;
